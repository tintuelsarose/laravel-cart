                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('product.edit', ['id' => $item->id]) }}" title="Edit"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('product.delete', ['id' => $item->id]) }}" title="Delete" onclick="return confirm('Are you sure you want to delete this product?')"><i class="fas fa-trash"></i></a>
